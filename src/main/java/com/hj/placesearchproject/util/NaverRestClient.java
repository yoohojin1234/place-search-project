...
public class NaverRestClient {
    ...
    public void setClientId(String clientId) { this.headers.set("X-Naver-Client-Id", clientId); }

    public void setClientSecret(String clientSecret) { this.headers.set("X-Naver-Client-Secret", clientSecret); }
